...
export class ServiceController {
    ...
    async findByInstitution(@Param('institutionId') institutionId: string) {
        ...
        if (services.length === 0) {
            throw new NotFoundException(
                `No services found for the institution with ID ${institutionId}`,
            );
        }
        return {
            statusCode: 200,
    ...
    async addInstitution(
        ...
        return this.serviceService.addInstitutionToService(
            serviceId,
            institutionId,
        );
    }
    ...
    removeInstitutionFromService(
        ...
        return this.serviceService.removeInstitutionFromService(
            serviceId,
            institutionId,
        );
    }
