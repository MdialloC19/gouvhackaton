...
export class DocumentController {
    ...
    @SwaggerApiResponse({
        status: 500,
        description: 'Échec de la création du document.',
    })
    async create(
    ...
    @SwaggerApiResponse({
        status: 500,
        description: 'Échec de la récupération du document.',
    })
    async getById(
        @Param('id') id: string,
    ): Promise<ApiResponse<DocumentEntity>> {
    ...
    @SwaggerApiResponse({
        status: 500,
        description: 'Échec de la récupération des documents.',
    })
    ...
    @Get('user/:userId')
    @ApiOperation({
        summary: 'Obtenir les documents uploadés par un utilisateur',
    })
    @ApiParam({
        name: 'userId',
    ...
    @SwaggerApiResponse({
        status: 200,
        description:
            "Documents récupérés avec succès pour l'utilisateur spécifié.",
        type: [DocumentEntity],
    })
    @SwaggerApiResponse({
        status: 404,
        description: 'Documents non trouvés pour cet utilisateur.',
    })
    @SwaggerApiResponse({
        status: 500,
        description: 'Échec de la récupération des documents par utilisateur.',
    })
